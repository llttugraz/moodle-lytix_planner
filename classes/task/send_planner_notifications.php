...
/**
 * Class send_planner_notifications
 */
class send_planner_notifications extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('cron_send_planner_notifications', 'lytix_planner');
    }
    ...
    public function execute() {
        if (get_config('local_lytix', 'platform') == 'learners_corner' ||
            ...
            foreach ($courseids as $courseid) {
                ...
                $sender->planner_notifications((int)$courseid);
            }
        }
    }
}
